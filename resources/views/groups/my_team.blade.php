                    ...
                    for (let i = 0; i < list_request_join.length; i++) {
                        ...
                        fetch("{{ url('/') }}/api/get_data_user_time_request_join" + '/' + memberId)
                            ...
                            .then(users => {
                                ...
                                let format_mission1 = users.mission1.toLocaleString();
                                ...
                                html_modal = `
                                    <div class="customers-list-item d-flex align-items-center p-2 cursor-pointer">
                                        ...
                                        <div class="list-inline d-flex customers-contacts ms-auto">
                                            <span class="btn btn-sm btn-accept list-inline-item" onclick="answer_request('Accept', '{{ $group_id }}','`+users.id+`' , '`+users.name+`' , '`+users.photo+`','`+countdown+`','`+format_mission1+`')">Accept</span>
                                            <span class="btn btn-sm btn-danger list-inline-item" onclick="answer_request('Reject', '{{ $group_id }}','`+users.id+`' , '`+users.name+`' , '`+users.photo+`','`+countdown+`','`+format_mission1+`')">Reject</span>
                                        </div>
                                    </div>
                                `;
