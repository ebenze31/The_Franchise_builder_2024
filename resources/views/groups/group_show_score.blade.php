            ...
            <div>
                <div>
                    <span style="color: #FCBF29;font-size: 12px;font-style: normal;font-weight: 700;line-height: 1;">Mission #1PC 
                        <span id="trophy_for_700K" class="d-none"><img src="{{ url('/img/icon/trophy.png') }}" style="margin-top: -6px;width: 16px;height:16px;position: relative!important;left: 5px !important;"></span>
                        ...
                        <div class="member-card-join">
                            ...
                            <div class="text-center">
                                ...
                                <div class="name-member w-100 mt-1" style="white-space: nowrap;  overflow: hidden;  text-overflow: ellipsis;width:95%">
                                    <span class="mt-1" style="color:#102160;font-size: 12px;font-style: normal;line-height: normal;">`+result['json'][i]['name_user']+`</span>
                                    ...
                                    <div class="d-flex justify-content-between ps-2 mt-1" style="border-radius: 5px;background:#102160;-webkit-border-radius: 5px;-moz-border-radius: 5px;white-space: nowrap;  overflow: hidden;  text-overflow: ellipsis;width:100%">
                                        <div>
                                            <span style="color: #FCBF29;font-size: 10px;font-style: normal;line-height: normal;">
                                                Active : 
                                            </span>
