            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/logs/' . $log->id . '/edit') }}" title="Edit Log"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Log Content </th><td> {{ $log->log_content }} </td></tr><tr><th> User Id </th><td> {{ $log->user_id }} </td></tr><tr><th> Role </th><td> {{ $log->role }} </td></tr>
                                </tbody>
                            </table>
                        </div>
