                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Title</th><th>Detail</th><th>Photo Content</th><th>Photo Cover</th><th>Link</th><th>User Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($news as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->title }}</td><td>{{ $item->detail }}</td><td>{{ $item->photo_content }}</td><td>{{ $item->photo_cover }}</td><td>{{ $item->link }}</td><td>{{ $item->user_id }}</td>
                                        <td>
