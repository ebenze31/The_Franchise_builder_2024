            ...
            fetch("{{ url('/') }}/api/get_activity" + "/" + for_url )
                ...
                .then(result => {
                    ...
                    if(result){
                      ...
                      let html_footer = `
                      <div class="d-flex justify-content-evenly mb-2">
                        <button type="button" style="width:90px;padding: 10px;"  class="btn btn-submit d-flex justify-content-center"  data-dismiss="modal"  onclick="cf_Activities('`+"{{ Auth::user()->id }}"+`' , '`+type+`')">
                            Confirm
                          </button>
