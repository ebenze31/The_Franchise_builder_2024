        ...
        <div id="navbar-botttom" class="mt-5">
            ...
            <div class="row justify-content-around mx-2">
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('rank-team')">
                    ...
                    <a href="{{ url('/end_mission_1') }}" onclick="return create_logs('010_Rank of Team');">
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('rank-individual')">
                    <a href="{{ url('/ranking_by_individual') }}" onclick="return create_logs('020_Rank of Individual');">
                        ...
                        <svg style="width: 28px; height: 28px;" width="37" height="44" viewBox="0 0 37 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="navbar-icon-rank-individual" fill-rule="evenodd" clip-rule="evenodd" d="M29.1822 11.8934C29.1822 17.7992 24.3946 22.5868 18.4888 22.5868C12.583 22.5868 7.79536 17.7992 7.79536 11.8934C7.79536 5.9876 12.583 1.2 18.4888 1.2C24.3946 1.2 29.1822 5.9876 29.1822 11.8934ZM21.7311 23.3395C26.7238 21.928 30.3822 17.3379 30.3822 11.8934C30.3822 5.32486 25.0573 0 18.4888 0C11.9202 0 6.59536 5.32486 6.59536 11.8934C6.59536 17.4252 10.372 22.075 15.4876 23.4049C9.38489 24.2206 5.5639 27.2464 3.29743 30.8715C0.778778 34.9 0.208317 39.618 0.448777 42.7439C0.474192 43.0743 0.762633 43.3216 1.09303 43.2962C1.42342 43.2707 1.67066 42.9823 1.64524 42.6519C1.4193 39.7146 1.96392 35.268 4.31493 31.5077C6.64369 27.7829 10.7733 24.6806 17.8522 24.4078C25.7065 24.1052 30.0386 27.1046 32.4448 30.8939C34.8839 34.7352 35.3983 39.4761 35.3985 42.6988C35.3985 43.0302 35.6671 43.2988 35.9985 43.2988C36.3299 43.2988 36.5985 43.0302 36.5985 42.6988C36.5983 39.3918 36.0782 34.3773 33.4578 30.2506C31.2575 26.7855 27.6137 24.0063 21.7311 23.3395Z" fill="white"/>
                        </svg>
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('scan')">
                    <a href="{{ url('/scanner') }}" onclick="return create_logs('060_QR');">
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('news')">
                    <a href="{{ url('/news/index') }}" onclick="return create_logs('070_News page');">
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('Profile')">
                    <a href="{{ url('/profile') }}" onclick="return create_logs('050_Profile page');">
                    <svg style="width: 28px; height: 28px;" width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="navbar-botttom" class="mt-5" style="z-index: 9999999999999999;">
            ...
            <div class="row justify-content-around mx-2">
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('mission-1')">
                    <a href="{{ url('/mission_2') }}" onclick="return create_logs('030_Mission2 page');">
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('grand')">
                    <a href="{{ url('/grand_mission') }}?Sort=pc" onclick="return create_logs('040_Grand Mission page');"    >
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('rank-individual')">
                    <a href="{{ url('/individual') }}" onclick="return create_logs('020_Rank of Individual');">
                        <!-- <svg style="width: 28px; height: 28px;" width="37" height="44" viewBox="0 0 37 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path class="navbar-icon-rank-individual" fill-rule="evenodd" clip-rule="evenodd" d="M29.1822 11.8934C29.1822 17.7992 24.3946 22.5868 18.4888 22.5868C12.583 22.5868 7.79536 17.7992 7.79536 11.8934C7.79536 5.9876 12.583 1.2 18.4888 1.2C24.3946 1.2 29.1822 5.9876 29.1822 11.8934ZM21.7311 23.3395C26.7238 21.928 30.3822 17.3379 30.3822 11.8934C30.3822 5.32486 25.0573 0 18.4888 0C11.9202 0 6.59536 5.32486 6.59536 11.8934C6.59536 17.4252 10.372 22.075 15.4876 23.4049C9.38489 24.2206 5.5639 27.2464 3.29743 30.8715C0.778778 34.9 0.208317 39.618 0.448777 42.7439C0.474192 43.0743 0.762633 43.3216 1.09303 43.2962C1.42342 43.2707 1.67066 42.9823 1.64524 42.6519C1.4193 39.7146 1.96392 35.268 4.31493 31.5077C6.64369 27.7829 10.7733 24.6806 17.8522 24.4078C25.7065 24.1052 30.0386 27.1046 32.4448 30.8939C34.8839 34.7352 35.3983 39.4761 35.3985 42.6988C35.3985 43.0302 35.6671 43.2988 35.9985 43.2988C36.3299 43.2988 36.5985 43.0302 36.5985 42.6988C36.5983 39.3918 36.0782 34.3773 33.4578 30.2506C31.2575 26.7855 27.6137 24.0063 21.7311 23.3395Z" fill="white"/>
                        </svg> -->
                        <svg  style="width: 28px; height: 28px;"  width="36" height="44" viewBox="0 0 36 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#fff" class="navbar-icon-rank-individual" fill-rule="evenodd" clip-rule="evenodd" d="M27.9992 12C27.9992 17.5228 23.522 22 17.9992 22C12.4763 22 7.99915 17.5228 7.99915 12C7.99915 6.47715 12.4763 2 17.9992 2C23.522 2 27.9992 6.47715 27.9992 12ZM22.0955 23.2826C26.7059 21.6084 29.9992 17.1888 29.9992 12C29.9992 5.37258 24.6266 0 17.9992 0C11.3717 0 5.99915 5.37258 5.99915 12C5.99915 17.2749 9.40265 21.7549 14.1334 23.3637C8.57968 24.3703 5.02132 27.3627 2.87087 30.9199C0.372293 35.053 -0.1887 39.8767 0.0490626 43.0733C0.0900279 43.624 0.569719 44.0373 1.12048 43.9964C1.67125 43.9554 2.08452 43.4757 2.04355 42.9249C1.82823 40.03 2.35047 35.6466 4.58242 31.9546C6.77778 28.3231 10.6637 25.2887 17.3887 25.0208C24.8661 24.7228 28.9283 27.6618 31.1869 31.3403C33.5004 35.1083 33.999 39.7865 33.9992 43C33.9992 43.5523 34.4469 44 34.9992 44C35.5515 44 35.9992 43.5522 35.9992 43C35.999 39.6535 35.4927 34.5307 32.8912 30.2938C30.8033 26.8932 27.4142 24.1452 22.0955 23.2826Z" fill="white"/>
                        </svg>
                        <p id="navbar-text-rank-individual" class="text-truncate" style="font-size: 11px; text-overflow: unset; color: rgb(255, 255, 255); filter: none;">
                            individual
                        </p>
...
<script>
  ...
  function change_menu_bar(menu){
    ...
    if(document.querySelector('#navbar-text-'+menu)){
                        ...
                        for (let i = 0; i < arr_read_not_read.length; i++) {
                            ...
                            fetch("{{ url('/') }}/api/get_data_news" + "/" + arr_read_not_read[i] )
                                ...
                                .then(data_news => {
                                    ...
                                    let a_html = `
                                        <a href="{{ url('/news/`+data_news.id+`') }}" id="a_news_id_`+data_news.id+`_modal" class="d-none" onclick="return create_logs('ne_${data_news.id} ${data_news.title} (Pop up)');"></a>
                                    `;
