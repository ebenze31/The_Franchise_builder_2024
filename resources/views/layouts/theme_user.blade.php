            ...
            <div class="row justify-content-around mx-2">
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('rank-team')">
                    <a href="{{ url('/ranking_by_team') }}">
                        ...
                        <p id="navbar-text-rank-team" class="text-truncate" style="font-size: 8px; text-overflow: unset; color: #fff; filter: none;">
                            Rank of team
                        </p>
                    </a>
                </div>
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('rank-individual')">
                    <a href="{{ url('/ranking_by_individual') }}">
                        ...
                        <p id="navbar-text-rank-individual" class="text-truncate" style="font-size: 8px; text-overflow: unset; color: rgb(255, 255, 255); filter: none;">
                        Rank of individual
                        </p>
                    </a>
                </div>
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('scan')">
                    ...
                    <p id="navbar-text-scan" class="text-truncate" style="font-size: 8px; text-overflow: unset; color: rgb(255, 255, 255); filter: none;">
                    QR code
                    </p>
                    </a>
                </div>
                ...
                <div class="col text-center text-truncate col-navbar mheebar" onclick="change_menu_bar('profile')">
                    ...
                    <p id="navbar-text-profile" class="text-truncate" style="font-size: 8px; text-overflow: unset; color: rgb(255, 255, 255); filter: none;">
                        Profile
                    </p>
                    </a>
                </div>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col text-center text-truncate col-navbar mheebar mt-0" onclick="change_menu_bar('team')">
                <a href="{{ url('/groups') }}">
                    ...
                    <p id="navbar-text-team" class="text-truncate" style="font-size: 8px; text-overflow: unset; color: #fff; filter: none;">
                        Team
                    </p>
                </a>
            </div>
